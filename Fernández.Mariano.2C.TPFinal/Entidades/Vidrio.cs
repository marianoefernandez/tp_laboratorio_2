...
namespace Entidades
{
    ...
    public class Vidrio : Mueble
    {
        ...
        public Vidrio(string nombre, int cantidad, float peso, float altura, float anchura, float profundidad) : base(nombre, cantidad, peso, altura, anchura, profundidad)
        {
        ...
        /// </summary>
        public Vidrio() : this(string.Empty, 0, 0, 0, 0, 0)
        {
        ...
        public static Vidrio operator +(Vidrio v1, Vidrio v2)
        {
            ...
            vidrio = new Vidrio(v1.Nombre, unidadesAux, v1.peso, v1.altura, v1.anchura, v1.profundidad);

...
namespace Entidades
{
    ...
    public abstract class Mueble
    {
        ...
        */
        ...
        public Mueble(string nombre, int unidades, float peso, float altura, float anchura, float profundidad)
        {
            this.nombre = nombre;
            this.peso = peso;
            this.altura = altura;
        ...
        {
            return !(this.Altura == "NO DISPONIBLE" || this.Peso == "NO DISPONIBLE" || this.Anchura == "NO DISPONIBLE" || this.Profundidad == "NO DISPONIBLE");
        }
        ...
        public virtual string Facturacion()
        {
            ...
            sb.AppendFormat("\nGasto en materia prima en {0}:{1:N2} $", this.Unidades, this.PrecioMateriaPrima);

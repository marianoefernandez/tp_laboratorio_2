...
namespace Entidades
{
    ...
    public class Metal : Mueble,IEsPintable
    {
        ...
        /// <summary>
        /// Propiedad que retorna el tipo del metal, se usa para la modificación
        /// </summary>
        public string TipoDeMetal
        {
            get
            {
                return this.tipoDeMetal.ToString();
            }
        }
        ...
        /// </summary>
        public Metal() : this(0,string.Empty, 0, 0, 0, 0, 0, eColor.Sin, eTipoDeMetal.Aluminio)
        {
        ...
        public static Metal operator +(Metal m1, Metal m2)
        {
            ...
            metal = new Metal(m1.id , m1.Nombre, unidadesAux, m1.peso, m1.altura, m1.anchura, m1.profundidad, m1.color, m1.tipoDeMetal);

...
namespace Entidades
{
    ...
    public class Madera : Mueble,IEsPintable
    {
        ...
        /// <summary>
        /// Propiedad que retorna el tipo de madera, se usa para la modificación
        /// </summary>
        public string TipoDeMadera
        {
            get
            {
                return this.tipoDeMadera.ToString();
            }
        }

        /// <summary>
        /// Propiedad que retorna el color, se usa para la modificación
        /// </summary>
        public string Color
        {
            get
        ...
        public Madera(int id,string nombre, int unidades, float peso, float altura, float anchura, float profundidad, eColor color, eTipoDeMadera tipo) : base(id,nombre, unidades, peso, altura, anchura, profundidad)
        {
            this.color = color;
        ...
        /// </summary>
        public Madera():this(0,string.Empty,0,0,0,0,0,eColor.Sin,eTipoDeMadera.Roble)
        {
        ...
        public override string Facturacion()
        {
            ...
            sb.AppendFormat("Gasto en materia prima en {0}:{1}", this.Unidades,this.PrecioMateriaPrima.FormatearPrecio());
            if (this.tipoDeMadera == eTipoDeMadera.Roble && this is Madera)
            {
                sb.AppendFormat("\nImpuesto al roble:{0}", this.Impuesto.FormatearPrecio());
            }
